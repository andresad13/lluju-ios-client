...
//	IF_ARC(
//		   uuid =(NSString *) (__bridge   void *)(uuidStringRef);
//		   ,
...
+ (NSString *)UUID
{
	...
	{
		IF_ARC(//1233测试
               _uuid = @"11233";// [[NSString alloc] initWithData:objc_retainedObject(resultData) encoding:NSUTF8StringEncoding];
			   ,
               _uuid = @"11233";//[[NSString alloc] initWithData:(NSData *)resultData encoding:NSUTF8StringEncoding];
