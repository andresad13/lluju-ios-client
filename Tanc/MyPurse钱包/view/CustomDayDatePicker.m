...
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        CGRect rect = CGRectMake(0, 0, self.bounds.size.width, 40.0 * 3 / IPHONE6SHEIGHT * HEIGHT);
        ...
        picker.center = CGPointMake(self.bounds.size.width / 2.0, self.bounds.size.height / 2.0);
...
-(UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view{
    ...
    mycom1.frame = CGRectMake(0, 0, self.frame.size.width/2.0, 40.0 / IPHONE6SHEIGHT * HEIGHT);
    //mycom1.font = Font15Pt;
    mycom1.backgroundColor = [UIColor clearColor];
...
{
    return 40.0 / IPHONE6SHEIGHT * HEIGHT;
}
