...
{
    UIActionSheet *sheet = [[UIActionSheet alloc] initWithTitle:@"要删除这张照片么" delegate:self cancelButtonTitle:@"cancel" destructiveButtonTitle:@"删除" otherButtonTitles:nil, nil];
